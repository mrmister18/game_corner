      ...
      <div className="row">
        <div>
          ...
          <div className="column" id="connect-four-board">
            <div className="row">
              {Array.from({ length: 7 }, (_, i) => i + 2).map((cell, idx) => (
                <div
                ...
                >
                  <div
                    className="hole"
                    style={
                      currentPlayer[0] === "Y" && preview === idx && !gameState.gameOver && gameState.message !== "Thinking..."
                        ? { backgroundColor: "yellow" }
                        : currentPlayer[0] === "R" && preview === idx && !gameState.gameOver && gameState.message !== "Thinking..."
                        ? { backgroundColor: "red" }
                        : null
                    }
                  ></div>
                        ...
                        onClick={() => {
                          if (
                            ...
                            if (
                              ...
                              gameStateCopy.message = checkWin(
                                currentPlayer[0],
                                gameStateCopy.board,
                                currentPlayer[1]
                              );
                              ...
                              gameStateCopy.message = checkTie(
                                gameStateCopy.board
                              );
                              gameStateCopy.gameOver = true;
                              setGameState(gameStateCopy);
          ...
          <div id="display-names" className="row" style={{marginTop:"15px"}}>
            <span
